...
UNIKR1   DFHMDF POS=(12,11),                                           X
               ...
               INITIAL='_____'
*
DATREZ1  DFHMDF POS=(14,3),                                            X
               LENGTH=7,                                               X
               ATTRB=(PROT),                                           X
               INITIAL='DATREZ:'
UNDREZ1  DFHMDF POS=(14,11),                                           X
               LENGTH=8,                                               X
               ATTRB=(UNPROT),                                         X
               COLOR=TURQUOISE,                                        X
               INITIAL='________'
OPDOD1   DFHMDF POS=(14,21),                                           X
               ...
               INITIAL='(DD/MM/GGGG)'
*
STATRZ1  DFHMDF POS=(16,3),                                            X
               LENGTH=7,                                               X
               ATTRB=(PROT,NORM),                                      X
               INITIAL='STATRZ:'
STATR1   DFHMDF POS=(16,11),                                           X
               LENGTH=5,                                               X
               ATTRB=(UNPROT),                                         X
               COLOR=TURQUOISE,                                        X
               INITIAL='_____'
OPSTS1   DFHMDF POS=(16,21),                                           X
               LENGTH=15,                                              X
               ATTRB=(PROT,NORM),                                      X
               COLOR=GREEN,                                            X
               INITIAL='1 - AKTIVNA'
